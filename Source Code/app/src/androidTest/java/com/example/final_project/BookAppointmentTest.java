...
public class BookAppointmentTest {
    ...
    public void changeText_sameActivity() {
        ...
        onView(withId(R.id.sundayCB)).perform(click());
        onView(withId(R.id.mondayCB)).perform(click());
        onView(withId(R.id.tuesdayCB)).perform(click());
        onView(withId(R.id.wednesdayCB)).perform(click());
        onView(withId(R.id.thursdayCB)).perform(click());
        onView(withId(R.id.fridayCB)).perform(click());
        onView(withId(R.id.saturdayCB)).perform(click());
